...
from chaski_player.common import MEDIA_DIR, atomic_write_json, merge_config, validate_config, validate_media_path, validate_url
...
class ConfigurationTests(unittest.TestCase):
    def test_complete_valid_configuration(self) -> None:
        ...
        self.assertEqual(config["player_name"], "SALA-04")
